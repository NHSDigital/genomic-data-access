...
![Build](https://github.com/NHSDigital/genomic-data-access/workflows/Build/badge.svg?branch=master)

This is a specification for the *genomic-data-access* API. This API will allow partners in the NHS Genomic Medicine Service to access and manage genomic data using standards-based APIs.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/genomic-data-access/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/genomic-data-access/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `genomic-data-access-target`.
